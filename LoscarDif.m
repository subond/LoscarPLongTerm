...
if myflag == 01;
    ...
    global Aoc rho Nb V A TH0 TH TS mv mhd kasv kkv TCv Sv Pv gp tA tI ...
        ...
        BlFlag CBl RBl kb FVC FVC13 Rvc pCSi nSi nCC Fkg Fkgs Fkg13 ...
        ...
        THt mv0 mhd0 oxA FSichck Finchck PPLv wcvtA wcvtI wcvtP wcvtT prodflag PBl runtime Rkg;

    Frp=[0 0 0 0];%3e10.*[0.2203 0.2251 0.3788 0.1758]; %Riverine Phosphate input mol/y
    Fpsed=3e10.*[0.2203 0.2251 0.3788 0.1758];
    ERR = 1; % report fc < 0 error on/off
    % if t<=5e5
    % CBl=flin(0,5e5,0,7500e15,t);
    % else
    %     CBl=0;
    % end
...
%      fsh=4.0;
    ...
    if(BlFlag == 2)
        ...
        DTS = 05.e5;   % n06 [10 1] e3 years 04
    ...
    if(prodflag)
        if(t>=0e6 && t<=runtime)
            %pp(1) = pp(1)+ 0.000000019;
            %pp(1) = pp(1)+ 2.8576e-008;
            pp(1) = pp(1)+ PBl/95/V(1)/runtime;
        end
    end
