...
%
%-------------------------------------
function yp = LoscarDifdCAPerm1backup(t,y)
...
global Aoc rho Nb V A TH0 TH TS mv mhd kasv kkv TCv Sv Pv gp tA tI ...
    ...
    acv ybbv ybv ycv runtime FERT epspv wcvtA wcvtI wcvtP wcvtT epspcaV inorgF epspF biopF;     
...
%      Fkg = flin (0,50e3, 1.0*5.e12/Aoc,0.0*5.e12/Aoc,t);
end
if(t>DTS)
...
% if(t<50e3)
% %     Fkg = flin(0,50e3,1.0*05.e12/Aoc,0.0*05.e12/Aoc,t) ;
%     Fkg = 1*02.5e12/Aoc;
% else
%     Fkg = 1*05.e12/Aoc;
% end
