...
Cam = 20.0e-3; % 10.3 (mol/kg) Calcium   modern
...
if myflag  == 01;
    if solflag == 01;
        ...
        global Aoc rho Nb V A TH0 TH TS mv mhd kasv kkv TCv Sv Pv gp tA tI ...
            ...
            Ns asvA asvI asvP zv m2kg rhos frrf frrfca phic hs FiN ...
            ...
            FprtAca FprtIca FprtPca phivtTca FprtTca EPLv EXLv ECLv...
            fwcv fwsv...
            fwsv1 fwgv fmgv pco2gca tgc kgc fbgv fmcv FSi0 fbcv pco20 Fkgs fbch fbbv...
            frkc fekc fdkc flakc FERT ACT RUN gamma fGG FiN0 Rkg LTflag acv ybbv ybv ycv epspv...
            dissvtAca dissvtIca dissvtPca dissvtTca;
        ...
        addpath('myode');
        CBl = 40000.e15; % Blast       2200  2000  3000 n2500
        % set DTS - duration of the initial carbon input pulse
        % this for BlFlag = 2;
        DTS = 1e5;    % 6e3 years for PETM; 1e5 Permian
        ...
        TDflag   = 1; % Temp sens to doubling CO2
        ...
        if(ftys)
            ...
            TCv0 = [TCv0 TCT]+0;
            CA3  = [20.0 20.0 20.0]*1e-3; % mol/kg Ca of boxes
%             CA3  = [10 10 10]*1e-3; % mol/kg Ca of boxes
        ...
        if(ftys)
            pRef  = 500.*1.;    % uatm, weathering ref   500  574 350  750 /2
        ...
        if(fsed) %<<<<<<<<<<<<<<<<<<<<<<< fsed
            if(fdox) % fdox
                ...
                if(CAvflag == 0)
                    Y0 = [c0  a0  p0 dox0 cca0 cc0 C0 CC0  fc0A    fc0I     fc0P ...
        ...
        if(ftys == 1)
            if (loadf == 1)
                ...
                elseif(bath == 2 && CAvflag == 2 && ~LTflag)
                    load dat/PETM44Ca/YPE10SedCAv1.DAT %for PETM set-up but Ca=20.00
                ...
                elseif(bath == 2 && CAvflag == 1)
                    load dat\PETM44Ca\YPE10SedCA1.DAT
                elseif(bath == 2 && CAvflag == 0 && ~LTflag)
        ...
        tic % start clock
        [tv,Y] = myode15s('LoscarDifdCA101',[t0 tfinal],Y0',options); % 23t 15s
        toc % stop  clock
        lt = length(tv);
        ...
        if(ftys == 1)
            if (savf == 1 && CAvflag == 2 && ~LTflag)
                ...
                save                    dat\PETM44Ca\YPE10SedCAv1.DAT  YPE10SedCAv1 -ASCII -DOUBLE -TABS;
            end
            if (savf == 1 && CAvflag == 2 && LTflag)
                YPE10SedCAv1LT = Y(lt,:)';
            ...
            if (savf == 1 && CAvflag == 1)
                ...
                save                    dat\PETM44Ca\YPE10SedCA1.DAT  YPE10SedCA1 -ASCII -DOUBLE -TABS;
            end
            if(savf == 1 && CAvflag == 0 && ~LTflag)
                YPE10Sed = Y(lt,:)';

                save                    dat\PETM44Ca\YPE10Sed.DAT YPE10Sed -ASCII -DOUBLE -TABS;
            end
            if(savf == 1 && CAvflag == 0 && LTflag)
                YPE10SedLT = Y(lt,:)';

                save                    dat\PETM44Ca\YPE10SedLT.DAT YPE10SedLT -ASCII -DOUBLE -TABS;
            end
        else
            if(savf == 1 && CAvflag == 0)
                YPE10SedM = Y(lt,:)';
    ...
    if(dYflag == 1)
        ...
        dYdt = ones(size(Y'));
        for i=1:lt
            dYdt(:,i) = LoscarDifdCA101(tv(i),Y(i,:)');
        end;
    end;
    ...
    if(fsed)
        ...
        if(CAvflag>0)
            rhc44  = (Fin44T+FSi44T-Fpr44T)*Aoc*Dt/Voc+DDiss44C; % mol/m3 ocean
        end;
...
cs = 'gggkkkrrrbgkr';
    ...
    legend('F_S_i','F_C')
    hndl1=plot(tv11, FSichck1(9,:),'m',tv11,Finchck1(9,:),'g');
    ...
    if(CAvflag~=0)
        subplot(716);plot(tv/(1e3),Ca*1e3)
    ...
    if(0)
        ...
        dostr2 = ['copy' dirstr '\YPE10Sedv.DAT'];
...
% lim=[0 110];
% asvAcum(1) = asvA(1);
% asvAcum(2) = asvA(1)+asvA(2);
% asvAcum(3)= asvA(1)+asvA(2)+asvA(3);
% asvAcum(4)= asvA(1)+asvA(2)+asvA(3)+ asvA(4);
% asvAcum(5)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5);
% asvAcum(6)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6);
% asvAcum(7)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6)+asvA(7);
% asvAcum(8)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6)+asvA(7)+asvA(8);
% asvAcum(9)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6)+asvA(7)+asvA(8)+asvA(9);
% asvAcum(10)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6)+asvA(7)+asvA(8)+asvA(9)+asvA(10);
% asvAcum(11)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6)+asvA(7)+asvA(8)+asvA(9)+asvA(10)+asvA(11);
% asvAcum(12)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6)+asvA(7)+asvA(8)+asvA(9)+asvA(10)+asvA(11)+asvA(12);
% asvAcum(13)= asvA(1)+asvA(2)+asvA(3)+ asvA(4) + asvA(5)+asvA(6)+asvA(7)+asvA(8)+asvA(9)+asvA(10)+asvA(11)+asvA(12)+asvA(13);
% asvPcum(1) = asvP(1);
% asvPcum(2) = asvP(1)+asvP(2);
% asvPcum(3)= asvP(1)+asvP(2)+asvP(3);
% asvPcum(4)= asvP(1)+asvP(2)+asvP(3)+ asvP(4);
% asvPcum(5)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5);
% asvPcum(6)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6);
% asvPcum(7)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6)+asvP(7);
% asvPcum(8)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6)+asvP(7)+asvP(8);
% asvPcum(9)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6)+asvP(7)+asvP(8)+asvP(9);
% asvPcum(10)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6)+asvP(7)+asvP(8)+asvP(9)+asvP(10);
% asvPcum(11)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6)+asvP(7)+asvP(8)+asvP(9)+asvP(10)+asvP(11);
% asvPcum(12)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6)+asvP(7)+asvP(8)+asvP(9)+asvP(10)+asvP(11)+asvP(12);
% asvPcum(13)= asvP(1)+asvP(2)+asvP(3)+ asvP(4) + asvP(5)+asvP(6)+asvP(7)+asvP(8)+asvP(9)+asvP(10)+asvP(11)+asvP(12)+asvP(13);
% asvTcum(1) = asvT(1);
% asvTcum(2) = asvT(1)+asvT(2);
% asvTcum(3)= asvT(1)+asvT(2)+asvT(3);
% asvTcum(4)= asvT(1)+asvT(2)+asvT(3)+ asvT(4);
% asvTcum(5)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5);
% asvTcum(6)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6);
% asvTcum(7)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6)+asvT(7);
% asvTcum(8)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6)+asvT(7)+asvT(8);
% asvTcum(9)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6)+asvT(7)+asvT(8)+asvT(9);
% asvTcum(10)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6)+asvT(7)+asvT(8)+asvT(9)+asvT(10);
% asvTcum(11)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6)+asvT(7)+asvT(8)+asvT(9)+asvT(10)+asvT(11);
% asvTcum(12)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6)+asvT(7)+asvT(8)+asvT(9)+asvT(10)+asvT(11)+asvT(12);
% asvTcum(13)= asvT(1)+asvT(2)+asvT(3)+ asvT(4) + asvT(5)+asvT(6)+asvT(7)+asvT(8)+asvT(9)+asvT(10)+asvT(11)+asvT(12)+asvT(13);
% asvIcum(1) = asvI(1);
% asvIcum(2) = asvI(1)+asvI(2);
% asvIcum(3)= asvI(1)+asvI(2)+asvI(3);
% asvIcum(4)= asvI(1)+asvI(2)+asvI(3)+ asvI(4);
% asvIcum(5)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5);
% asvIcum(6)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6);
% asvIcum(7)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6)+asvI(7);
% asvIcum(8)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6)+asvI(7)+asvI(8);
% asvIcum(9)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6)+asvI(7)+asvI(8)+asvI(9);
% asvIcum(10)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6)+asvI(7)+asvI(8)+asvI(9)+asvI(10);
% asvIcum(11)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6)+asvI(7)+asvI(8)+asvI(9)+asvI(10)+asvI(11);
% asvIcum(12)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6)+asvI(7)+asvI(8)+asvI(9)+asvI(10)+asvI(11)+asvI(12);
% asvIcum(13)= asvI(1)+asvI(2)+asvI(3)+ asvI(4) + asvI(5)+asvI(6)+asvI(7)+asvI(8)+asvI(9)+asvI(10)+asvI(11)+asvI(12)+asvI(13);
%
% figure(30)
% plot(asvAcum*100, dsv);
% set(gca,'YDir','reverse');
% set(gca,'XLim',lim);
% hold on
% plot(asvIcum*100, dsv);
% hold on
% plot(asvPcum*100, dsv);
% hold on
% plot(asvTcum*100, dsv);
% hold off
