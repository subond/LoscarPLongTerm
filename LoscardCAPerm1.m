    ...
    if solflag == 01;
        ...
        global Aoc rho Nb V A TH0 TH TS mv mhd kasv kkv TCv Sv Pv gp tA tI ...
            ...
            fwsv1 fwgv fmgv pco2gca tgc kgc fbgv fmcv FSi0 fbcv pco20 Focw0 fbch fbbv...
             flakc FERT ACT RUN gamma fGG FiN0 Rkg LTflag acv ybbv ybv ycv epspv wcvtA wcvtI wcvtP wcvtT...
            ...
            Floegel rREGv REDPCv meanSpco2v dbc alphagc;
...
%         [fbgv,fbcv,fwgv,fmcv,fmgv,fwcv,fGGi,fgkc,frkc,fekc,fdkc,rco2,pco2gca]=gcfun12(dbc(tgc), tgc);
...
%         ca]=gcfun11(d13c);
        ...
        Pscenario = 0; % 0 - default Phosphate weathering scenario, po4bf 0.5%
        ...
        if(ftys)
            ...
            if(Pfeed)
                Focw0  = (4.5801e+012)/Aoc;%1*05.e12/Aoc;
            else
